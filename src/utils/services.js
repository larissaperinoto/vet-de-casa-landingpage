export default [
  ...
  {
    icon: "https://img.icons8.com/ios-filled/500/FFFFFF/microscope.png",
    title: "Exames",
    content: "São muito importantes, pois auxiliam diretamente em um diagnóstico mais seguro. Os exames mais comuns realizados são exames de sangue, citologia de massas e nódulos, exame de pele para detecção de fungos e sarnas, exame de fezes (coproparasitológico) e testes rápidos para diagnóstico de doenças como cinomose, parvovirose e FIV/FeLV."
  },
  {
    icon: "https://img.icons8.com/ios-filled/500/FFFFFF/file-2.png",
    title: "Atestados",
    content: "O atestado é uma exigência sanitária das companhias de transporte. Para a emissão do atestado, o animal passa por uma consulta onde será avaliado a situação vacinal e o estado clínico geral. Então, caso seu pet precise de atestado sanitário, o Vet de Casa também oferece esse serviço!"
  }
]